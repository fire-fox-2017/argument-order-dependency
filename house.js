...
class House {
  ...
  constructor(components) {
    ...
    if (components.hasOwnProperty("num_bedrooms")){
        this.num_baths = components ["num_bedrooms"]}
    ...
    if(components.hasOwnProperty("has tenants")){
...
const cool = new House({address: 'jalankesonokesini', square_feet: 100, num_bedrooms: 2, num_baths: 2, cost: 12345, down_payment: 12345, sold:true, short_sale: true})
